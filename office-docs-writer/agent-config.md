...
> **3.5 版记与历史稿检查**（仅红头/带版记文档）：参阅 `guidelines/footer-imprint.md`；有历史稿时须先执行 `guidelines/historical-docx-reference.md` 四步协议
...
- 不得将版记中的 Markdown 表格跳过或写成普通段落
- 不得仅凭截图推断 Word 结构，须用 python-docx 或 OOXML 检查历史稿
